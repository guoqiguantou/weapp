...
Page({
  data: {
    ...
    holiday_url: serverList.serverWorker + "Work/selectAllleId",
    update_url: serverList.serverWorker + "Work/updateLeave",
    add_url: serverList.serverWorker + "Work/addLeave",
    formData: {
      id: "",
      workerId: "",
      workerName: "",
