...
Page({
  ...
  data: {
    ...
    currentRouter: {
      ...
      urlById: serverList.serverWorker + "Work/selectadvanceFee",
      urlByIdMoney: serverList.serverWorker + "farmhand/findListBySid",
      add: {
        url: serverList.serverWorker + "Work/addAdvanceFee",
        workerName: "申请人",
        date: "申请时间",
        money: "预支金额(元)"
      },
      edit: {
        url: serverList.serverWorker + "Work/addRepayment",
        workerName: "还款人",
        date: "还款时间",
        money: "还款金额(元)"
      }
