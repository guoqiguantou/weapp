...
Page({
  data: {
    ...
    workerGS_url: serverList.serverWorker + "Temporary/selectAllNoneWhId",
    update_url: serverList.serverWorker + "Temporary/updateWorkingHours",
    add_url: serverList.serverWorker + "Temporary/addWorkingHours",
    formData: {
      id: "",
      workerId: "",
      workerName: "",
