...
Page({
  ...
  submit() {
    ...
    if (machineName == "" || machineName == null) {
      ...
      if (this.data.id) {
        //编辑
        $request({
          url: app.globalData.serverHYH + "farm/updateMachineryinfo",
          type: "form",
        ...
        //添加
        $request({
          url: app.globalData.serverHYH + "farm/addMachineryinfo",
          type: "form",
  ...
  onLoad: function (options) {
    ...
    if (options.id) {
      ...
      $request({
        url: app.globalData.serverHYH + "farm/selectMachineryinfoMiId",
        type: "form",
        params: {
