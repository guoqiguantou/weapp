...
Page({
  ...
  data: {
    ...
    currentRouter: {
      ...
      moneyById: serverList.serverWorker + "labor/findListBySid",
      workerInfo_url: serverList.serverWorker + "labor/findOneBywsId",
      workTime_url: serverList.serverWorker + "labor/findBywsIdHours",
      add: {
        url: serverList.serverWorker + "labor/addLabor",
      },
      edit: {
