  ...
  data: {
    routerList: {
      subMoney: {
        name: "预支总金额",
        title: "预支总金额",
        url_Query: serverList.serverWorker + "Work/selectadvanceFee",
        navUrl_edit: "../payerHandle/payerHandle"
      },
      subMoneyed: {
        name: "已还总金额",
        title: "已还总金额",
        url_Query: serverList.serverWorker + "Work/selectAllDebt",
        url_del: serverList.serverWorker + "Work/updateAdvanceIsD"
      }
    },
    currentRouter: {},
    id: "",
