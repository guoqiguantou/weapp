...
Page({
  ...
  data: {
    ...
    routerList: {
      "edit": {
        name: "补贴编辑",
        "url_update": serverList.serverBook + "subsidy/updateSubsidy",
        "url_queryType": serverList.serverBook + "subsidy/selectSubsidyType",
        'url_Query': serverList.serverBook + "subsidy/selectSubsidyById",
      },
      "add": {
        name: "补贴新增",
        "url_queryType": serverList.serverBook + "subsidy/selectSubsidyType",
        "url_add": serverList.serverBook + "subsidy/insertsubsidy",
      }
    },
    currentRouter: {},
