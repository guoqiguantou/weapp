...
Page({
  ...
  data: {
    ...
    routerList: {
      'returnedMoney': {
        name: "回款记录",
        'url_Query': serverList.serverBook + "returnmoney/selectReturnMoneyOrderByamount", //查询的接口地址
        'url_del': serverList.serverBook + "returnmoney/isInvalidReturnMoney", //删除的接口地址
      ...
      'subsidy': {
        name: "补贴记录",
        'url_Query': serverList.serverBook + "subsidy/selectSubsidyOrderByamount",
        'url_del': serverList.serverBook + "subsidy/isInvalidSubsidy",
      ...
      'holiday': {
        name: "请假记录",
        'url_Query': serverList.serverWorker + "Work/selectLeave",
        'url_del': serverList.serverWorker + "Work/updateIsInvalid",
