...
Page({
  ...
  submit() {
    ...
    if (this.data.id) {
      //编辑
      $request({
        url: serverList.serverBook + "subsidy/updateSubsidy",
        type: "form",
      ...
      //添加
      $request({
        url: serverList.serverBook + "subsidy/insertsubsidy",
        type: "form",
  ...
  subKind() {
    $request({
      url: serverList.serverBook + "subsidy/selectSubsidyType",
      type: "form",
      params: {
        token: "token"
      }
  ...
  onLoad: function (options) {
    ...
    if (options.param) {
      ...
      $request({
        url: serverList.serverBook + "subsidy/selectSubsidyById",
        type: "form",
        params: {
