...
Page({
  ...
  data: {
    ...
    routerList: {
      "edit": {
        name: "编辑",
        "url_update": serverList.serverBook + "returnmoney/updateReturnMoney",
        'url_Query': serverList.serverBook + "returnmoney/selectReturnMoneyById",
      },
      "add": {
        name: "新增",
        "url_add": serverList.serverBook + "returnmoney/insertReturnMoney",
      }
    },
    currentRouter: {},
